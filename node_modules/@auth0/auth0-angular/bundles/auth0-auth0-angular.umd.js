(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var useragent = { name: '@auth0/auth0-angular', version: '1.5.0' };
    ...
    var AuthService = /** @class */ (function () {
        ...
        AuthService.prototype.handleRedirectCallback = function (url) {
            var _this = this;
            return rxjs.defer(function () { return _this.auth0Client.handleRedirectCallback(url); }).pipe(operators.withLatestFrom(this.isLoadingSubject$), operators.tap(function (_c) {
                var _d = __read(_c, 2), result = _d[0], isLoading = _d[1];
                var _a, _b;
                if (!isLoading) {
                    _this.refreshState$.next();
                }
